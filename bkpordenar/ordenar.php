...
<!---Mostrar errores via php-->
  ...
  <div class="form-group col-md-4" id="agencia-envio">
    ...
    <select id="pais" class="form-control" name="pais" required="required">
        ...
        <option value="rep_dom">Caribe Tours</option>
        <option value="rep_dom">Metro</option>
        <option value="rep_dom">Vimenpaq</option>
      </select>
 ...
 <div class="form-group">
  ...
  <h4 class="heading-2" id="productos" >Seleccione el Producto a Ordenar</h4>
   <div id="showLate-Night-Pink" class="myDiv">
	<img src="img/negrorosado/1.jpg" alt="Manager" class="img-responsive img-thumbnail"/><span>Negro Rosado </span><br>
</div>
<div id="showZafiro" class="myDiv">
	<img src="img/blue/4.jpg" alt="HR" class="img-responsive img-thumbnail"/><span>Azul Negro</span>
</div>
<div id="showTiffany-Blue" class="myDiv">
	<img src="img/lightblue/1.jpg" alt="Developer" class="img-responsive img-thumbnail"/><span>Azul Cielo</span>
</div>

 <div id="showGolden-Black" class="myDiv">
	<img src="img/negrooro/1.jpg" alt="Developer" class="img-responsive img-thumbnail"/><span>Negro Oro</span>
</div>

 <div id="showIrish-Green" class="myDiv">
	<img src="img/verdeoro/1.jpg" alt="Verde Oro" class="img-responsive img-thumbnail"/><span>Verde Oro</span>
</div>
 <div id="showPink-Mist" class="myDiv">
	<img src="img/greypink/1.jpg" alt="Developer" class="img-responsive img-thumbnail"/><span>Gris Rosado</span>
</div>
  ...
  <div class="form-row d-flex">
   ...
   <div class="metodo_pago form-group col-md-3">
      ...
      <select id="metodo_pago" class="form-control" name="metodo_pago" required="required">
        <option>Seleccionar</option>
  ...
  <select id="myselection" class="form-control col-md-3" name="color" required="required">
